...
<h3 align="center">thenocturnaldevgypsy-io/ama - Ask me anything!</h3>
<p align="center"><em>This is a quick ask-me-anything type of repository. Got the inspiration from <a href="https://github.com/holman/feedback">@holman's feedback repo</a> and seems like simple yet a great idea in lieu of traditional blog comments, email, and such.</em></p>
...
<p align="center">
   ...
   <img src="https://img.shields.io/badge/Version-2.0.3-%2300416a?logoColor=white&labelColor=%2300416a&color=%2324292e&textColor=white" alt="Version 2.0.3">
...
Ask [@thenocturnaldevgypsy-io](https://github.com/thenocturnaldevgypsy-io) about... anything you want, in [my AMA repo](https://github.com/thenocturnaldevgypsy-io/ama-ask-me-anything).

## ![SECTION Ask a question](https://custom-icon-badges.demolab.com/badge/-Ask%20a%20question-24292e?logo=megaphone&logoColor=white&labelColor=00416a)

Asking a question is as easy as [creating a new issue](https://github.com/thenocturnaldevgypsy-io/ama-ask-me-anything/issues/new) on this repo.
...
## ![SECTION Read old questions](https://custom-icon-badges.demolab.com/badge/-Read%20old%20questions-24292e?logo=comment-discussion&logoColor=white&labelColor=00416a)

Check out the [closed Issues](https://github.com/thenocturnaldevgypsy-io/ama-ask-me-anything/issues?sort=created&direction=desc&state=closed&page=1) filter on this repository to browse questions I've answered in the past. I try to use this as an email replacement that everyone can see, so feel free to dig into some of the older threads.
...
- Edit the `README.md` (make sure to change the name and links and all that) and make the necessary changes for the `shields.io` or `custom-icon-badges.demolab.com` badges codes.
